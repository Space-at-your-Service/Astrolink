		...
		<b-navbar toggleable="lg" class="bg-white" style="box-shadow: 0px 3px 15px darkred">
			...
			<b-collapse id="nav-collapse" is-nav>
				...
				<b-navbar-nav class="ml-auto">
					...
					<b-nav-item to="/communication" :class="[{ active : isActive === 'communication' }, 'hover-bg-crimson']" @click="isActive = 'communication'" v-if="isAllowed('activities.view_communication')">Communication</b-nav-item>
